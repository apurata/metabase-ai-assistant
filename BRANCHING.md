...
4. **Upstream:** paused — see dormancy note above. When it is allowed again: same remote feature branch, human OK first; after accept, sync `main` and keep `apurata` current.
